                                            ...
                                            <div class="more-menu">
                                                ...
                                                <ul class="more-menu-items" tabindex="-1" role="menu"
                                                    ...
                                                    <li class="more-menu-item" role="presentation">
                                                        ...
                                                        <a href="process.php?action=assignRider&id=<?php echo $singleRow['User']['id']; ?>&orderID=<?php echo $orderId; ?>">
                                                        <button
...
<script>
    <?php 
        ...
        {
            // echo [$singleRow['User']['first_name'],$lat,$long;];
            $locationArray.= "['".$singleRow['User']['first_name']." ".$singleRow['User']['last_name'] ."',".$lat.",".$long."],";
        }
    ...
    var locations = 
    [
        <?php echo $locationArray; ?>
    ];


    var map = new google.maps.Map(document.getElementById('map'), {
        zoom: 8,
        center: new google.maps.LatLng(31.4558711,73.1298893),
